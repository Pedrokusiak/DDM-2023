...
R:Parâmetros do tipo função em linguagens de programação permitem que uma função receba como entrada outra função como argumento. 
Isso significa que uma função pode chamar outra função dentro de seu próprio corpo, ou passá-la como argumento para outra função.
Os parâmetros do tipo função são frequentemente usados em programação para implementar algoritmos mais flexíveis e genéricos, 
permitindo que as funções possam ser reutilizadas com diferentes implementações de funções, tornando o código mais modular e com menos repetições de código.
