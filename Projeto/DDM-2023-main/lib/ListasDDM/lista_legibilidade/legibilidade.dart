...
void exemploFuncao() {
  // o nome desta função ajuda na compreensão do seu objetivo? Não pois ela nao especifica oque a função tem que realizar, um nome melhor seria, verificaAprovação
  double n1,
      n2,
      m; // o que é n1? n2? m?   n1 e n2 são referentes às notas que o aluno recebeu em 2 avaliaçoes. E a variavel M se refere ao calculo da media.
  ...
  m = (n1 + n2) /
      2; // o que este código faz? Será que não seria melhor dividir a expressão para diminuir a complexidade e definir variáveis com nomes que ajude a entender o código?
  if (m > 6) {
    print('aprovado');
  } else {
    print('reprovado');
...
bool verificarAprovacao(double nota1, double nota2) {
  // nome de acordo com o valor que será passado
  var media = calcularMedia(nota1,
      nota2); // definindo variáveis que ajude a entender o que está sendo realizado
  return media > 6;
}
